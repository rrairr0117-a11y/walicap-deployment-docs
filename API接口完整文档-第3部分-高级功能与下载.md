...
```json
{
  ...
  // 下载选项
  "format": "best",                   // string, 下载格式: "best", "mp4", "webm", "specific"
  "quality": "1080p",                 // string, 视频质量: "2160p", "1440p", "1080p", "720p", "480p", "360p", "best", "worst"
  "prefer_free_formats": false,       // boolean, 是否优先选择免费格式, 默认: false
  
  // 处理选项
  "extract_audio": false,             // boolean, 是否仅提取音频, 默认: false
  "audio_format": "mp3",              // string, 音频格式(extract_audio为true时): "mp3", "aac", "wav"
  "merge_format": "mp4",              // string, 合并后的格式: "mp4", "mkv", "webm"
  
  // 字幕选项
  "download_subtitles": false,        // boolean, 是否下载字幕, 默认: false
  "subtitle_languages": ["zh", "en"], // array, 字幕语言列表
  "embed_subtitles": false,           // boolean, 是否嵌入字幕, 默认: false
  
  // 限制选项
  "max_filesize": "500M",             // string, 最大文件大小: "100M", "500M", "1G"
  "rate_limit": "1M",                 // string, 下载速度限制: "500K", "1M", "5M"
  
  // 输出选项
  "filename_pattern": "%(title)s.%(ext)s", // string, 文件名模板
  "output_path": "/downloads/",       // string, 输出路径
...
```json
{
  ...
  // 下载选项
  "chunk_size": 8192,                 // integer, 分块大小(字节), 范围: 1024-1048576, 默认: 8192
  "timeout": 300,                     // integer, 超时时间(秒), 范围: 30-3600, 默认: 300
  "max_retries": 3,                   // integer, 最大重试次数, 范围: 0-10, 默认: 3
  
  // 范围请求
  "range_start": 0,                   // integer, 起始字节位置, 默认: 0
  "range_end": null,                  // integer, 结束字节位置, null表示到文件末尾
  
  // 验证选项
  "verify_ssl": true,                 // boolean, 是否验证SSL证书, 默认: true
  "follow_redirects": true,           // boolean, 是否跟随重定向, 默认: true
  "max_redirects": 5,                 // integer, 最大重定向次数, 范围: 0-10, 默认: 5
  
  // 输出选项
  "encode_base64": false,             // boolean, 是否返回base64编码, 默认: false
  "return_metadata": true,            // boolean, 是否返回文件元数据, 默认: true
